        ...
        <div className='banner-shap it-wrapper'>
          <div className='container py-20'>
            <div className='flex flex-wrap gap-6'>
              ...
              >
                <h1 className="text-white relative max-w-[490px]">
                ...
                <p className="text-base font-normal text-white leading-7 pb-11 max-w-473">
                  Get pre-qualified commercial cleaning leads—no cold calling.
                  We book appointments for janitorial companies with businesses
                  actively seeking cleaning services.
                </p>
              ...
              <div
                className="md:w-1/4 w-full md:-ml-16 -ml-0 relative z-10 before:absolute before:content-[''] before:bg-[url('/images/hero/grid-line.png')] before:bg-no-repeat before:w-24 before:h-24 before:-top-32 before:-right-16 lg:before:inline-block before:hidden after:content-[''] after:absolute after:bg-[url('/images/hero/circal.png')] after:bg-no-repeat after:w-[2.625rem] after:h-[2.625rem] after:top-10 after:-left-[8.25rem] xl:after:inline-block after:hidden"
                data-aos="fade-left"
                data-aos-delay="200"
                data-aos-duration="1000"
              >
                <form action={bookAppointment}>
                  <h2 className="text-white sm:text-[26px] leading-[2.11rem] text-xl font-bold pb-5">
